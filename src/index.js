...
icon.src = "data:image/svg+xml;base64,";
span.appendChild(icon);
span.appendChild(heading);
const subHeadingContainer = document.createElement("span");
const subHeading = document.createElement("h4");
subHeading.textContent = "A simple To-Do";
subHeadingContainer.appendChild(subHeading);
span.appendChild(subHeadingContainer);
let options = load("dashBoardOptions");
if (
  load("dashBoardOptions") === null ||
  load("dashBoardOptions") === undefined ||
  load("dashBoardOptions") === ""
) {
  [
    {
      value: "New List",
...
const createListItem = (option, index) => {
  ...
  listItem.addEventListener("click", () => {
    ...
    if (currentTab !== button.textContent) {
      container.removeChild(currentChild);
