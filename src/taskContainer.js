...
const createTask = (todo) => {
  ...
  deleteIcon.src = "data:image/svg+xml;base64,";
...
const loadList = (listContainer) => {
  const todoList = showToDos();
  todoList.forEach((todo) => {
    listContainer.appendChild(createTask(todo));
  });
}
